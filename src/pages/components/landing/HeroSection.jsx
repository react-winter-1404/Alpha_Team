    ...
    <section className="my-10 mx-auto w-[90%] md:w-3/5 text-center " >
      <div className="items-center justify-center flex flex-wrap gap-5 my-5 text-[33px] md:text-[40px] lg:text-[48px]">
        ...
        <Chip 
                ...
                >
        <HugeiconsIcon icon={ThirdBracketCircleIcon} className=" m-0 w-8 h-8 text-muted   " />
        </Chip>
      ...
      <p className="text-[16px] md:text-[20px] w-[80%] mx-auto text-muted opacity-80 my-5">آکادمی فوق تخصصی کدنویسی و برنامه‌نویسی از سنین کودکی تا بزرگسالی</p>
