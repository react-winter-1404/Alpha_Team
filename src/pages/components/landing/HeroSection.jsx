...
const Hero = () => {
  return (
    <section className="my-10 mx-auto w-[90%] md:w-3/5 text-center " >
      <div className="items-center justify-center flex flex-wrap gap-5 my-5 text-[33px] text md:text-[48px]">
        <p className=" ">تجربه‌ای بی‌نظیر در یادگیری</p>
        <Chip 
                  isIconOnly 
                  disableRipple
                  variant="flat" 
                  className="hidden md:block text-xl w-12 h-12 rounded-full flex justify-center items-center text-center shadow-xl"
                >
