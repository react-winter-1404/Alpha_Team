...
const Footer = () => {
  return (
    <div className="p-3 w-[90%] md:h-[350px] mx-auto rounded-[30px] bg-[#e4e4e4] mt-[50px] flex flex-wrap justify-between items-center">

      <div className="w-[40%] md:w-[10%] md:h-[70%] flex flex-col gap-3">
        <img src="/public/icons/Untitled-1 2.svg" alt="" />
        <img src="/public/icons/insta.png" alt="" />
        <img src="/public/icons/tel.png" alt="" />
      </div>

      <div className="w-[40%] md:w-[20%] md:h-[80%]">
      ...
      <div className="w-[40%] md:w-[20%] md:h-[80%] flex justify-between items-start">
