      ...
      <div className="w-full h-full flex flex-wrap justify-center align-middle gap-4 ">
        {
          ...
          (
          course.map((e) => (
            <div key={e.courseId} className="relative text-[#272727] bg-[#ece8e8] h-[530px] w-[90%] md:w-[22%] flex flex-col gap-2 rounded-[20px] text-right">
              ...
              <div className="p-2 flex flex-col gap-4">
                ...
                <p className="text-[14px] md:text-[16px] w-[80%] h-[50px] text-[#787878] line-clamp-2">{e.describe}</p>
                ...
                <div className="text-[16px] mb-2 flex justify-start items-center gap-3">
                  ...
                  <span>{formatPersianDate(e.startTime)} <span className="text-[#787878]">(شروع)</span></span>
                </div>
                ...
                <div className="flex justify-between align-middle">
                  <p className="text-[20px] md:text-[24px] text-[#272727]">{e.cost}<span className="text-[14px] md:text-[16px] text-[#3772ff]" > تومان </span></p>
