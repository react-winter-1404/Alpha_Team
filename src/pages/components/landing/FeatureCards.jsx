...
export default function FeatureCards() {
  return (
    <div className="flex flex-wrap md:justify-center items-center gap-7.5 w-[90%] my-12.5 mx-auto">
      <div className=" relative w-[90%] mx-auto md:mx-0 md:w-[40%] h-[332px] border-[3px]  rounded-[30px] text-right overflow-hidden bg-surface-secondary ">
      ...
      <div className="w-[90%] relative md:w-[30%] mx-auto md:mx-0 h-[332px] rounded-[30px] bg-[#3772FF]">
      ...
      <div className="w-[90%] md:w-[25%] mx-auto md:mx-0 h-[332px] border-[3px]  rounded-[30px] bg-surface-secondary">
        <div className="flex justify-between items-center p-5">
