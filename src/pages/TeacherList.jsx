...
const TeacherList = () => {
  ...
  return (
    <div className="p-10 max-w-7xl mx-auto font-sans" style={{ direction: "rtl" }}>
      <h1 className="text-center text-3xl font-bold mb-10 text-gray-800">لیست اساتید</h1>
      
      <div className="grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-8">
        {teachers.map((teacher) => (
          <div 
            key={teacher.teacherId} 
            className="group relative rounded-xl overflow-hidden shadow-md aspect-[3/4] cursor-pointer bg-gray-100"
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center opacity-0 transition-all duration-400 p-5 text-center group-hover:opacity-100">
              ...
              <p className="text-purple-400 text-lg font-medium drop-shadow-sm">تعداد دوره‌ها: {teacher.courseCounts}</p>
              {teacher.linkedinProfileLink && (
                <a 
                  href={teacher.linkedinProfileLink} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="mt-5 text-[#0077b5] bg-white hover:bg-gray-100 px-5 py-2 rounded-full text-sm font-bold shadow-md transition-all active:scale-95"
