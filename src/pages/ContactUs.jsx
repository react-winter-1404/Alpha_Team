        ...
        <div className="flex my-8 md:my-15 gap-8 md:gap-11 lg:gap-14">
          <div className="flex flex-col gap-5 md:gap-8 lg:gap-10">
            ...
            <motion.div 
              ...
              animate="visible"
            >
              <motion.div variants={iconVariants} className="w-10 h-10 sm:w-12 sm:h-12 lg:w-15 lg:h-15 flex items-center justify-center rounded-md bg-[rgba(55,114,255,0.231)] text-accent cursor-pointer hover:bg-accent hover:text-white duration-150">
                <HugeiconsIcon
                  icon={Call02Icon}
                  size={24}
                  strokeWidth={1.5}
