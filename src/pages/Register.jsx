...
const RegisterPage = () => {
  ...
  return (
    <div className=" border  w-full h-full flex flex-col-reverse sm:flex-row gap-5 sm:gap-0 ">
      <div className=" border h-full w-full sm:w-[41.5%] flex flex-col justify-center sm:justify-start gap-10.75 lg:px-11.5 md:px-5 sm:px-0  sm:py-20.25 bg-default ">
