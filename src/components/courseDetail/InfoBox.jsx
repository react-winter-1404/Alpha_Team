  ...
  return (
    <div className="border-4 max-h-screen w-full mx-auto max-w-120 lg:max-w-none lg:w-[40.75%] lg:sticky top-29 bg-overlay flex flex-col rounded-3xl px-5 pt-3.25 pb-5">
      ...
      <div className="font-semibold flex gap-1.5 items-end">
        <span className="text-xl lg:text-[28px]">{cost && cost.toLocaleString("fa-IR")}</span>
      ...
      <div className="flex justify-between gap-3 items-center mt-4 lg:mt-7.5">
        <AlertDialog isOpen={isShowReserveCourseModal} onOpenChange={setIsShowReserveCourseModal}>
          <Button onClick={() => { setIsShowReserveCourseModal(false); fetchAddCourseReserve(); }} className="w-[56%] h-10 lg:h-14 rounded-full font-bold text-lg lg:text-xl pb-2">
            رزرو دوره
          </Button>
          <AlertDialog.Backdrop>
            <AlertDialog.Container>
              <AlertDialog.Dialog className="lg:max-w-140">
                <AlertDialog.Header>
                  <AlertDialog.Heading>
                    <Chip variant="primary" color="success" className="w-full flex justify-center items-center gap-2 lg:text-xl text-white h-12 rounded-full">
                ...
                <AlertDialog.Body>
                  <div className="flex items-center my-7 lg:my-10">
                    <svg xmlns="http://www.w3.org/2000/svg" width="160" height="48" viewBox="0 0 160 48" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div className="flex flex-col">
                      <Chip variant="tertiary" className="flex items-center justify-center border-4 text-[15px] w-18 h-18 lg:h-25 lg:w-25 rounded-full px-2.5 pb-1.5">
                ...
                <AlertDialog.Footer className="gap-5 mt-10">
                  <Button slot="close" className="w-[68%] h-11 lg:h-13 lg:text-xl pb-1 lg:pb-2 rounded-full">
        ...
        <Button onClick={toggleFavorite} variant="outline" className={`w-10 h-10 lg:h-14 lg:w-14 rounded-full p-0 text-2xl transition-all duration-300 ${isFavorited ? "bg-danger border-danger text-white hover:bg-danger-hover" : "hover:bg-field-hover"}`}>
