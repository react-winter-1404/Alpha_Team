            ...
            return (
              ...
              >
                <div className="w-full h-auto sm:h-14.25 flex items-center gap-2 sm:gap-3">
                  <div className="h-10 w-10 sm:h-14.25 sm:w-14.25 flex justify-center items-center bg-accent text-white rounded-full shrink-0">
                    <HugeiconsIcon
                      icon={MailEdit02Icon}
                      className="w-4 sm:w-5"
                    />
                  </div>
                  <div className=" font-bold lg:text-[19.25px] md:text-[16px] sm:text-[14.5px] whitespace-nowrap ">
                    {e.describe}
                  </div>
                </div>
              </motion.div>
                ...
                <div className="w-full h-auto sm:h-11 flex items-center gap-2 sm:gap-3 mr-0 sm:mr-1.5">
                  <div className="h-8 w-8 sm:h-11 sm:w-11 flex justify-center items-center bg-overlay rounded-full shrink-0">
                    <HugeiconsIcon
                      ...
                      className="w-3.5 sm:w-5"
                    />
                  </div>
                  <div className="flex flex-col text-field-placeholder text-[11px] gap-0.5 sm:gap-0.75">
                    <div className="font-bold text-[13px] whitespace-nowrap ">{e.describe}</div>
                  </div>
                </div>
              </motion.div>
            );
