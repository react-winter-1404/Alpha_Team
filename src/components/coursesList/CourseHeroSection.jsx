...
import star1 from "../../assets/Courses/Star 1.ico";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ما به شما کمک می‌کنیم تا با کمک‌های آموزشی تخصصی، تنوعی از دوره‌های
          برنامه‌نویسی و کدنویسی خود را به سطح بالاتری برسانید تا مهارت پیدا کنید.
        </motion.p>
