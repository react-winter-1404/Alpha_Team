      ...
      >
        <NavbarContent>
          <NavbarBrand className="gap-3">
            <div
              onClick={() => navigate("/")}
              className="cursor-pointer w-full overflow-hidden h-11.75 flex items-center gap-1.5 px-1"
            >
              <img
        ...
        <NavbarContent className="gap-2 md:gap-4">
          ...
          >
            <Link
              ...
              className="text-sm mb-1 md:text-[16px]"
            >
              {isLoged ? t("navbar.profile") : t("navbar.login")}
            </Link>
          </Button>
          ...
          >
            <div className="dark:bg-[rgb(28,27,34)] bg-overlay p-4 w-full h-full flex flex-col gap-3 border-b">
              <div className="flex justify-between items-center">
                ...
                <CloseButton
                  onClick={() => setIsMenuOpen(false)}
                  className="bg-danger-soft text-danger w-7 h-7 rounded-full"
                />
              </div>
