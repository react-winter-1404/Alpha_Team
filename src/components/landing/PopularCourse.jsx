          ...
          course.map((e) => (
            ...
            >
              ...
              <div className="p-2 flex flex-col gap-4">
                <h3 className="text-[20px] md:text-[24px] h-[40px] mb-2.5">
                  {e.title}
                </h3>
                ...
                <div className="text-[16px] mb-2 flex justify-start items-center gap-3">
                  <img
                    src="/icons/teacher-stroke-rounded 1.png"
                    alt=""
                    className="h-6 w-6"
                  />
                ...
                <div className="text-[16px] mb-2 flex justify-start items-center gap-3">
                  <img
                    src="/icons/calendar-03-stroke-rounded 1.png"
                    alt=""
                    className="h-6 w-6"
                  />
                  <span>
                    {formatPersianDate(e.startTime)}{" "}
                    <span className="text-[#787878] dark:text-[#bdbbbb]">
                      (شروع)
                    </span>
                  </span>
                </div>
                ...
                <div className="text-[16px] mb-2 flex justify-start items-center gap-3">
                  <img
                    src="/icons/students-stroke-rounded 1.png"
                    alt=""
                    className="h-6 w-6"
                  />
                ...
                <div className="flex justify-between align-middle">
                  <p className="text-[20px] md:text-[24px] text-[#272727] dark:text-[#bdbbbb]">
                    {e.cost}
                    <span className="text-[14px] md:text-[16px] text-[#3772ff] ">
                      {" "}
                      تومان{" "}
                    </span>
                  </p>
