  ...
  return (
    <div>
      ...
      <div className="mt-5 w-full h-[681px] rounded-[16px] bg-[#fefdff] p-3 flex flex-col justify-start items-center">
        ...
        <div className="w-full h-[48px] bg-[#f0f0f0] rounded-[16px] flex justify-start items-center gap-30 p-3">
        ...
        {/* <div></div>  اینجا باید یک استیت داشته باشیم که دوره هایی که کاربر ستاره دار میکنه اون تو ذخیره بشن و ما اینجا ازش استفاده کنیم. کار با ریداکس یا کانتکس ای پی ایه */}
