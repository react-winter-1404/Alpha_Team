    ...
    <div>
      ...
      <div className="mt-5 w-full h-[681px] rounded-[16px] bg-[#fefdff] p-3 flex flex-col justify-start items-center">
        ...
        <div className="w-full h-[48px] bg-[#f0f0f0] rounded-[16px] flex justify-start items-center gap-3 p-3">
          <span className="text-[16px] text-[#787878] ml-[260px]">#</span>
          <span className="text-[16px] text-[#787878] ml-[260px]">عنوان</span>
          <span className="text-[16px] text-[#787878] ml-[50px]">درباره مقاله</span>
          <span className="text-[16px] text-[#787878] ml-[35px]">منتشرکننده</span>
          <span className="text-[16px] text-[#787878] ml-[90px]">تاریخ انتشار</span>
        </div>
