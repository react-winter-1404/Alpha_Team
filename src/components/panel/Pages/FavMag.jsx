  ...
  return (
    <>
      <div className="hidden md:block">
        <h3 className="text-[32px] text-foreground mt-5">{t("favMag.title")}</h3>
        ...
        <div className="flex justify-start items-center gap-5 mt-7">
          <div>
            <div className="flex justify-start items-center gap-2">
              ...
              <span className="text-[16px] text-foreground">{t("favMag.searchArticle")}</span>
            </div>

            <div className="relative mt-3">
              <input
                type="text"
                placeholder={t("favMag.searchPlaceholder")}
                value={searchTerm}
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 font-bold text-sm mb-1 text-foreground">
                ...
                <span>{t("favMag.publishDate")}</span>
              </div>
        ...
        <div className="mt-5 w-full h-[681px] rounded-[16px] bg-overlay p-3 flex flex-col justify-start items-center">
          <div className="w-full h-[48px] text-muted bg-default rounded-[16px] flex justify-between items-center p-3">
            ...
            <span className="w-[15%] flex justify-center">{t("favMag.title")}</span>
            <span className="w-[15%] flex justify-center">{t("favMag.publisher")}</span>
            <span className="w-[15%] flex justify-center">{t("favMag.aboutArticle")}</span>
            <span className="w-[15%] flex justify-center">{t("favMag.publishDate")}</span>
            ...
            {isLoading ? (
              ...
              <div className="flex justify-center items-center h-full text-muted text-lg">
                {searchTerm || dateRange.start || dateRange.end
                  ? t("favMag.noArticlesFound")
                  : t("favMag.noFavArticles")}
              </div>
            ) : (
      ...
      <div className="block md:hidden">
        <div className="flex justify-between items-center">
          <h3 className="text-[32px] text-foreground">{t("favMag.title")}</h3>
          <button className="w-[83px] h-[41px] rounded-[64px] bg-accent text-[16px] text-accent-foreground">{t("favMag.filter")}</button>
        </div>
