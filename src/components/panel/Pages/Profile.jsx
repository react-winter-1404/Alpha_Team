...
const ProfilePanel = () => {
  ...
  const fetchUserProfile = async () => {
    ...
    try {
      ...
      setAddDate(response.data.insertDate)
        ...
        <div className="p-[30px] w-full h-[120px] flex justify-between items-center">
          <div className="w-[550px] h-[30px]">
            <div className="flex justify-start items-center gap-4 mt-10">
              <h3 className="text-[36px] text-[#272727]">{userProfile.fName+' '+userProfile.lName}</h3>
            ...
            <div className="flex justify-start items-center gap-2 mt-4">
              ...
              <div className="flex justify-center items-center gap-2">
                <img
                  ...
                  className="w-[20px] h-[28.53px]"
                />
                <span className="text-[16px]">{addDate && new Date(addDate).toLocaleDateString('fa-IR', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
              </div>
          ...
          <div className="w-[400px] h-[30px] mt-30">
            ...
            <p className="text-[16px] text-[#272727] mt-2">{userProfile.userAbout}</p>
          </div>
        </div>
      </div>
