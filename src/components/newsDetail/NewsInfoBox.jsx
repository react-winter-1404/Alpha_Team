      ...
      <div className="flex flex-col gap-3 mt-0">
        ...
        <div className="flex justify-between gap-3 items-center">
          <div className="flex items-center gap-4">
            <img src={addUserProfileImage} alt="" className="bg-border w-12 h-12 lg:w-14 lg:h-14 rounded-full object-cover" />
          ...
          <div className="w-[40%] lg:w-[50%] flex gap-2 justify-between items-center">
            <Button
              ...
              variant="outline"
              className={`w-10 h-10 lg:h-14 lg:w-14 rounded-full p-0 text-2xl transition-all duration-300 ${isFavorited ? "bg-danger border-danger text-white hover:bg-danger-hover" : "hover:bg-field-hover"}`}
            >
