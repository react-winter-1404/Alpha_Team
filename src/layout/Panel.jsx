...
import { Moon02Icon, Sun03Icon,DashboardCircleIcon,Book02Icon,TimeSetting03Icon,BookBookmark02Icon,FileBookmarkIcon,UserEdit01Icon,MoneySend02Icon,UserSettings01Icon,Logout01Icon,MoreHorizontalCircle01Icon,Notification01Icon } from "@hugeicons/core-free-icons";
...
const Panel = () => {
  ...
  return (
    <div className="fixed inset-0 w-screen min-h-screen p-3 md:p-5 flex flex-col md:flex-row gap-3 bg-default overflow-auto">
        ...
        <div className="mt-40">
          <ul>
            ...
            <li className="mb-[10px] w-[228px] h-[53px] rounded-[38px] text-right flex justify-start items-center text-danger bg-default cursor-pointer">
              ...
              <span className="text-[18px]  indent-4">
                خروج از حساب
              </span>
            </li>
          </ul>
      ...
      <div className="flex-1 w-full rounded-[16px]">
        <div className="w-full p-2.5 rounded-[16px] md:bg-overlay flex sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex justify-between items-center w-[120px] h-full">
            <button className=" relative text-xl w-[56px] h-[56px] cursor-pointer border-solid border dark:border-gray-600 rounded-full border-gray-200 text-center flex items-center justify-center ">
      ...
      <div className="md:hidden w-full h-[60px] rounded-[30px] bg-overlay border-overlay border  flex justify-between items-center">
        <div
          onClick={() => {
            setDashboard(true);
            setMyCourse(false);
          ...
          className={`${ dashboard ? 'bg-accent text-accent-foreground':'bg-default'} w-[50px] h-[50px] rounded-[38px]  flex items-center justify-center`}
        >
        ...
        <div
          ...
          className={`${ myCourse ? 'bg-accent text-accent-foreground':'bg-default'} w-[50px] h-[50px] rounded-[38px]  flex items-center justify-center`}
        >
        ...
        <div
          ...
          className={`${ myReserve ? 'bg-accent text-accent-foreground':'bg-default'} w-[50px] h-[50px] rounded-[38px]  flex items-center justify-center`}
        >
        ...
        <div
          ...
          className={`${ profile ? 'bg-accent text-accent-foreground':'bg-default'} w-[50px] h-[50px] rounded-[38px]  flex items-center justify-center`}
        >
        ...
        <div
          ...
          className="relative w-[50px] h-[50px] rounded-[38px]  flex items-center justify-center bg-default"
        >
          ...
          {smallMenu && (
            <div className="absolute top-[-250px] left-2 w-[221px] h-[248px] rounded-[16px] bg-surface-secondary shadow-2xl flex flex-col justify-center items-center">
              <ul className="m-0 p-0">
                ...
                <li className="flex justify-start items-center gap-3 p-2 cursor-pointer ">
