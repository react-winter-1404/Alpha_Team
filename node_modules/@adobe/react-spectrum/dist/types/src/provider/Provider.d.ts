 ...
 */
export declare const Provider: React.ForwardRefExoticComponent<ProviderProps & React.RefAttributes<import("@react-types/shared").DOMRefValue<HTMLDivElement>>>;
/**
 ...
 */
export declare function useProvider(): ProviderContext;
