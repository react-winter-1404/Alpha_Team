...
.P3i24W_spectrum-StatusLight[disabled], .P3i24W_spectrum-StatusLight.P3i24W_is-disabled {
  color: var(--spectrum-statuslight-text-color-disabled, var(--spectrum-alias-text-color-disabled));
}

:is(.P3i24W_spectrum-StatusLight[disabled], .P3i24W_spectrum-StatusLight.P3i24W_is-disabled):before {
