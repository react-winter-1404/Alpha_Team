...
function $1f2a1f451a6aa23a$var$ActionGroupItem({ item: item, state: state, isDisabled: isDisabled, isEmphasized: isEmphasized, staticColor: staticColor, onAction: onAction, hideButtonText: hideButtonText, orientation: orientation }) {
    ...
    let button = /*#__PURE__*/ (0, ($parcel$interopDefault($gC6oF$react))).createElement((0, $gC6oF$reactariaprivateinteractionsPressResponder.PressResponder), (0, $gC6oF$reactariamergeProps.mergeProps)(buttonProps, hoverProps, domProps), /*#__PURE__*/ (0, ($parcel$interopDefault($gC6oF$react))).createElement((0, $feede71cddc0c5f3$exports.ClearSlots), null, /*#__PURE__*/ (0, ($parcel$interopDefault($gC6oF$react))).createElement((0, $feede71cddc0c5f3$exports.SlotProvider), {
        slots: {
            text: {
...
function $1f2a1f451a6aa23a$var$ActionGroupMenu({ state: state, isDisabled: isDisabled, isEmphasized: isEmphasized, staticColor: staticColor, items: items, onAction: onAction, summaryIcon: summaryIcon, hideButtonText: hideButtonText, isOnlyItem: isOnlyItem, orientation: orientation, ...otherProps }) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($gC6oF$react))).createElement((0, $98227f5fd590c993$exports.MenuTrigger), {
