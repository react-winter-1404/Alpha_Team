...
:is(.A-RCEa_spectrum-Slider-track, .A-RCEa_spectrum-Slider-buffer, .A-RCEa_spectrum-Slider-fill):first-of-type:before {
...
:is(.A-RCEa_spectrum-Slider-track, .A-RCEa_spectrum-Slider-buffer, .A-RCEa_spectrum-Slider-fill):last-of-type:before {
...
:is(.A-RCEa_spectrum-Slider-tick:first-of-type, .A-RCEa_spectrum-Slider-tick:last-of-type) .A-RCEa_spectrum-Slider-tickLabel {
  margin-block: var(--spectrum-slider-label-gap-x, var(--spectrum-global-dimension-size-200)) 0;
  margin-inline: 0;
  display: block;
  position: absolute;
...
.A-RCEa_spectrum-Slider-tick:first-of-type .A-RCEa_spectrum-Slider-tickLabel {
...
.A-RCEa_spectrum-Slider--color .A-RCEa_spectrum-Slider-controls:before, .A-RCEa_spectrum-Slider--color .A-RCEa_spectrum-Slider-track {
...
.A-RCEa_spectrum-Slider-controls:before {
  inset-inline-start: calc(calc(var(--spectrum-slider-handle-width, var(--spectrum-global-dimension-size-200)) / 2) * -1);
}

.A-RCEa_spectrum-Slider-controls:after {
  inset-inline-end: calc(calc(var(--spectrum-slider-handle-width, var(--spectrum-global-dimension-size-200)) / 2) * -1);
}
...
.A-RCEa_spectrum-Slider--color .A-RCEa_spectrum-Slider-controls:before {
  ...
  background-image: linear-gradient(-45deg, transparent 75.5%, var(--spectrum-global-color-static-gray-500, #bcbcbc) 75.5%),
...
.A-RCEa_spectrum-Dial-handle:active, .A-RCEa_spectrum-Dial-handle.A-RCEa_is-dragged {
  background-color: var(--spectrum-dial-border-color-hover, var(--spectrum-global-color-gray-800));
  border-color: var(--spectrum-slider-handle-border-color-down, var(--spectrum-global-color-gray-800));
}

:is(.A-RCEa_spectrum-Dial-handle:active, .A-RCEa_spectrum-Dial-handle.A-RCEa_is-dragged):after {
  background-color: var(--spectrum-dial-handle-marker-color-key-focus, var(--spectrum-global-color-gray-50));
}
