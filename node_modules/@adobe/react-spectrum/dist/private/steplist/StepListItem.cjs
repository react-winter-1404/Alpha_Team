...
function $712472d83922a2e9$export$87c2a8a94eda1754(props) {
    ...
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($9ihVH$react))).createElement((0, $9ihVH$reactariaVisuallyHidden.VisuallyHidden), stepStateProps, stepStateText), /*#__PURE__*/ (0, ($parcel$interopDefault($9ihVH$react))).createElement("div", {
        id: labelId,
        "aria-hidden": "true",
