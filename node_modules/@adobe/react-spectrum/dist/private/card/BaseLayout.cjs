...
class $b9ec4ce2ddaeda0a$export$64943d2e59d72a29 extends (0, $h4riM$reactstatelyuseVirtualizerState.Layout) {
    ...
    getFirstKey() {
        ...
        return (0, $h4riM$reactstatelyprivatecollectionsgetChildNodes.getFirstItem)((0, $h4riM$reactstatelyprivatecollectionsgetChildNodes.getChildNodes)(firstRow, this.collection))?.key;
    }
    getLastKey() {
        let lastRow = this.collection.getItem(this.collection.getLastKey());
        return (0, $h4riM$reactstatelyprivatecollectionsgetChildNodes.getFirstItem)((0, $h4riM$reactstatelyprivatecollectionsgetChildNodes.getChildNodes)(lastRow, this.collection))?.key;
    }
