...
class $7c753442ee8aa648$export$64943d2e59d72a29 extends (0, $5Ooik$Layout) {
    ...
    getFirstKey() {
        ...
        return (_getFirstItem = (0, $5Ooik$getFirstItem)((0, $5Ooik$getChildNodes)(firstRow, this.collection))) === null || _getFirstItem === void 0 ? void 0 : _getFirstItem.key;
    }
    getLastKey() {
        var _getFirstItem;
        let lastRow = this.collection.getItem(this.collection.getLastKey());
        return (_getFirstItem = (0, $5Ooik$getFirstItem)((0, $5Ooik$getChildNodes)(lastRow, this.collection))) === null || _getFirstItem === void 0 ? void 0 : _getFirstItem.key;
    }
