...
class $47544ce7688f5862$export$64943d2e59d72a29 extends (0, $8Gj3P$Layout) {
    ...
    getFirstKey() {
        ...
        return (0, $8Gj3P$getFirstItem)((0, $8Gj3P$getChildNodes)(firstRow, this.collection))?.key;
    }
    getLastKey() {
        let lastRow = this.collection.getItem(this.collection.getLastKey());
        return (0, $8Gj3P$getFirstItem)((0, $8Gj3P$getChildNodes)(lastRow, this.collection))?.key;
    }
