.u4Zobq_express.u4Zobq_express {
  ...
  --spectrum-alias-heading-text-font-weight-regular: var(--spectrum-global-font-weight-black, 900);
  ...
  --spectrum-alias-input-focusring-gap: var(--spectrum-global-dimension-static-size-25, 2px);
  --spectrum-alias-input-border-color-key-focus: var(--spectrum-global-color-gray-900);
  --spectrum-alias-input-focusring-size: var(--spectrum-global-dimension-static-size-25, 2px);
  ...
  --spectrum-actionbutton-border-color: var(--spectrum-actionbutton-background-color, var(--spectrum-global-color-gray-75));
  --spectrum-actionbutton-border-color-hover: var(--spectrum-actionbutton-background-color-hover, var(--spectrum-global-color-gray-50));
  --spectrum-actionbutton-border-color-key-focus: var(--spectrum-actionbutton-background-color-key-focus, var(--spectrum-global-color-gray-50));
  --spectrum-actionbutton-border-color-down: var(--spectrum-actionbutton-background-color-down, var(--spectrum-global-color-gray-200));
  --spectrum-actionbutton-quiet-background-color-hover: var(--spectrum-actionbutton-background-color-hover, var(--spectrum-global-color-gray-50));
  --spectrum-actionbutton-quiet-background-color-key-focus: var(--spectrum-actionbutton-background-color-key-focus, var(--spectrum-global-color-gray-50));
  --spectrum-actionbutton-quiet-background-color-down: var(--spectrum-actionbutton-background-color-down, var(--spectrum-global-color-gray-200));
  --spectrum-actionbutton-quiet-border-color-hover: var(--spectrum-actionbutton-border-color-hover, var(--spectrum-alias-border-color-hover));
  --spectrum-actionbutton-quiet-border-color-key-focus: var(--spectrum-actionbutton-border-color-key-focus, var(--spectrum-alias-border-color-focus));
  --spectrum-actionbutton-quiet-border-color-down: var(--spectrum-actionbutton-border-color-down, var(--spectrum-alias-border-color-down));
  ...
  --spectrum-actionbutton-static-black-background-color: #00000012;
  --spectrum-actionbutton-static-black-background-color-disabled: #00000012;
  ...
  --spectrum-actionbutton-static-white-background-color: #ffffff12;
  --spectrum-actionbutton-static-white-background-color-disabled: #ffffff12;
  --spectrum-fieldbutton-background-color: var(--spectrum-actionbutton-background-color, var(--spectrum-global-color-gray-75));
  --spectrum-fieldbutton-background-color-hover: var(--spectrum-actionbutton-background-color-hover, var(--spectrum-global-color-gray-50));
  --spectrum-fieldbutton-background-color-key-focus: var(--spectrum-actionbutton-background-color-key-focus, var(--spectrum-global-color-gray-50));
  --spectrum-fieldbutton-background-color-down: var(--spectrum-actionbutton-background-color-down, var(--spectrum-global-color-gray-200));
  --spectrum-fieldbutton-border-color: var(--spectrum-actionbutton-border-color, var(--spectrum-alias-border-color));
  --spectrum-fieldbutton-border-color-hover: var(--spectrum-actionbutton-border-color-hover, var(--spectrum-alias-border-color-hover));
  --spectrum-fieldbutton-border-color-key-focus: var(--spectrum-actionbutton-border-color-key-focus, var(--spectrum-alias-border-color-focus));
  --spectrum-fieldbutton-border-color-error-key-focus: var(--spectrum-fieldbutton-border-color-error, var(--spectrum-global-color-red-500));
  --spectrum-fieldbutton-border-color-down: var(--spectrum-actionbutton-border-color-down, var(--spectrum-alias-border-color-down));
  --spectrum-breadcrumb-button-gap: var(--spectrum-global-dimension-static-size-50, 4px);
  ...
  --spectrum-combobox-fieldbutton-focus-ring-border-radius: var(--spectrum-alias-border-radius-regular, var(--spectrum-global-dimension-size-50));
  --spectrum-combobox-fieldbutton-start-border-radius: calc(var(--spectrum-alias-border-radius-regular, var(--spectrum-global-dimension-size-50)) + var(--spectrum-alias-input-border-size));
  ...
  --spectrum-slider-track-border-radius: var(--spectrum-alias-border-radius-xsmall, var(--spectrum-global-dimension-size-10));
  --spectrum-slider-fill-track-height: var(--spectrum-slider-track-height, var(--spectrum-alias-border-size-thick));
  --spectrum-slider-fill-track-color: var(--spectrum-global-color-gray-600);
  --spectrum-slider-handle-gap: 0px;
  --spectrum-slider-handle-border-size-down: var(--spectrum-slider-handle-border-size, var(--spectrum-alias-border-size-thick));
  ...
  --spectrum-tag-border-size: var(--spectrum-global-dimension-static-size-25, 2px);
  ...
  --spectrum-tooltip-dropshadow: drop-shadow(0 var(--spectrum-alias-dropshadow-offset-y, var(--spectrum-global-dimension-size-10)) var(--spectrum-alias-dropshadow-blur, var(--spectrum-global-dimension-size-50)) var(--spectrum-alias-dropshadow-color));
...
.u4Zobq_express.u4Zobq_medium {
  --spectrum-switch-track-width: 28px;
}

.u4Zobq_express.u4Zobq_large {
  --spectrum-switch-track-width: 36px;
}

@media (forced-colors: active) {
  .u4Zobq_express.u4Zobq_express {
    --spectrum-popover-border-size: var(--spectrum-alias-border-size-thin, var(--spectrum-global-dimension-static-size-10));
  }
}
/*# sourceMappingURL=vars_express.css.map */
