...
export declare const Fieldset: (<E extends keyof React.JSX.IntrinsicElements = "fieldset">({ className, ...props }: import("./fieldset").FieldsetRootProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof import("./fieldset").FieldsetRootProps<E>>) => import("react/jsx-runtime").JSX.Element) & {
    Root: <E extends keyof React.JSX.IntrinsicElements = "fieldset">({ className, ...props }: import("./fieldset").FieldsetRootProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof import("./fieldset").FieldsetRootProps<E>>) => import("react/jsx-runtime").JSX.Element;
